...
# -*- coding: utf-8 -*-
"""
Created on Mon May 19 16:12:54 2025
...
psnr_scores_not_inf = [x for x in psnr_scores if np.isfinite(x)]
avg_psnr = np.mean(psnr_scores_not_inf)
...
#df_results.to_csv("/home/linuxu/Desktop/final_project/Adversarial-Data-Encryption/encryption/attack_test_results.csv", index=False)
print(df_results)
